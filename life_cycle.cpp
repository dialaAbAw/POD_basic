...
/* function cycle: iterates the life cycle until "equilibrium".
 ...
 nbtype: number of haplotypes in the total pop
 */

void recursion(int Nv, double av, int rv, int nLv, double nEqv, double sPv, double hPv, double linkPv, double sv, double hv, double Uv, double Lv, double Unv, int sampleSv, int nbgenev, int nbgenv, int pasv, int repv, int Gv, double m, int nbtype)

{
    ...
    std::vector<double> inds[nbtype]; //possibility to code this as a table
